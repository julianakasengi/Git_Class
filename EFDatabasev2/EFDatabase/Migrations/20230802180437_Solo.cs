    ...
    public partial class Solo : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("Pk_Joined", x => new { x.SubjectId, x.StudentID });
                    table.ForeignKey(
                        name: "FK_StudentSubjectJoin_Students_StudentID",
                        column: x => x.StudentID,
                        principalTable: "Students",
                        principalColumn: "StudentID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentSubjectJoin_Subject_SubjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentSubjectJoin_StudentID",
                table: "StudentSubjectJoin",
                column: "StudentID");
